    ...
    <div className="company">
      ...
      <Form.Item
        ...
        <Form.Item label="Company Name" name="companyName"
         validateStatus={formik.touched.companyName && formik.errors.companyName ? 'error' : 'success'}
         help={formik.touched.companyName && formik.errors.companyName}>
          ...
          onBlurCapture={formik.handleBlur}
          onBlur={()=>{setIsValid(Object.values(formik.errors).every(val => val === undefined))}}
          style={{borderColor: formik.errors.companyName ? "red": "green"}}
          />
        </Form.Item>
        <Form.Item label="Tax Id" name="taxId"
         validateStatus={formik.touched.taxId && formik.errors.taxId ? 'error' : 'success'}
         help={formik.touched.taxId && formik.errors.taxId}>
          ...
          onBlurCapture={formik.handleBlur}
          onBlur={()=>{setIsValid(Object.values(formik.errors).every(val => val === undefined))}}
          style={{borderColor: formik.errors.taxId ? "red": "green"}} />
        </Form.Item>
